...
export default function Home() {
  ...
  const operationsItems = appMenuItems.filter(item => {
    if (item.title === "Inventory Management" || item.title === "Staff Time Clock" || item.title === "Staff Schedule" || item.title === "Lead Feedback" || item.title === "Cash Check" || item.title === "Cash Transactions" || item.title === "Vendor Receipts" || item.title === "Add Used Club") {
