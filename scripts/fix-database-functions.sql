...
DROP FUNCTION IF EXISTS get_inventory_overview_with_reorder_status();
DROP FUNCTION IF EXISTS get_product_trend_data(UUID);
...
-- Success message
SELECT 'Database functions fixed successfully!' as message; 