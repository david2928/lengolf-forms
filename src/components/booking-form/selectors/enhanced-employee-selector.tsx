...
export function EnhancedEmployeeSelector({
  ...
  const employees = [
    ...
    { value: 'Ashley', label: 'Ashley', gradient: 'from-amber-500 to-amber-600', bgColor: 'bg-amber-50', borderColor: 'border-amber-200' },
    { value: 'First', label: 'First', gradient: 'from-purple-500 to-purple-600', bgColor: 'bg-purple-50', borderColor: 'border-purple-200' }
  ]
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-3 gap-4">
        {employees.map((employee) => {
          ...
          const isUnselected = value && value !== employee.value && value !== otherName
